...
class CraftFirstDraftGen:
    ...
    def getAllSeoSubtopicsText(self, countSeoSubtopics):
        ...
        for i in range(1, countSeoSubtopics+1):
            subtopic_text = self.driver.find_element(By.XPATH, self.txt_subtopicText_xpath.replace('8', str(i))).text
    ...
    def addSeoSubtopic(self, subtopicNo):
        self.driver.find_element(By.XPATH, self.button_plus_xpath.replace('8', str(subtopicNo))).click()
    ...
    def addFirstSeoSubtopic(self):
        self.driver.find_element(By.XPATH, self.button_plus_xpath.replace('8', str(1))).click()

    def addLastSeoSubtopic(self, countSeoSubtopics):
        self.driver.find_element(By.XPATH, self.button_plus_xpath.replace('8', str(countSeoSubtopics))).click()
    ...
    def getAllGrafiSubtopicsText(self, countGrafiSubtopics):
        ...
        for i in range(1, countGrafiSubtopics+1):
            subtopic_text = self.driver.find_element(By.XPATH, self.txt_grafiSubtopicText_xpath.replace('8', str(i))).text
            lst_subtopics.append(subtopic_text)
        return lst_subtopics
    ...
    def addLastGrafiSubtopic(self, countGrafiSubtopics):
        self.driver.find_element(By.XPATH, self.button_plus_xpath.replace('8', str(countGrafiSubtopics))).click()
    ...
    def getAllReferencesText(self, countReferences):
        ...
        for i in range(1, countReferences+1):
            reference_text = self.driver.find_element(By.XPATH, self.txt_referenceText_xpath.replace('8', str(i))).text
    ...
    def addReference(self, referenceNo):
        reference_checkbox_element = self.driver.find_element(By.XPATH, self.checkbox_reference_xpath.replace('8', str(referenceNo)))
    ...
    def setSubtopic(self, subtopic_text):
        subtopic_element = self.driver.find_element(By.XPATH, self.txt_subtopic_xpath)
